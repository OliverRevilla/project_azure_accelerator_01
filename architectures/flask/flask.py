...
from flask.flask import Flask, render_template, jsonify, Response, request
...
assistant_thread: Optional[threading.Thread] = None #assistant_thread → Un hilo donde correrá el asistente.
assistant_instance = None #assistant_instance → El objeto que representa al asistente.
assistant_loop: Optional[asyncio.AbstractEventLoop] = None #assistant_loop → El event loop async del asistente.
ws_server_thread: Optional[threading.Thread] = None #ws_server_thread → Un hilo donde correrá el servidor WebSocket.
